#!/bin/bash
# Qinghe BFD v2.0.1-beta.14 - macOS uninstaller.
...
echo "============================================"
echo "  清何剪辑工具箱 v2.0.1-beta.14 测试版 macOS 卸载"
echo "============================================"
echo "将删除："
echo "  $EDIT_DIR/$MAIN_SCRIPT"
echo "  $SCRIPT_BASE/$MAIN_SCRIPT"
echo "  $COMP_DIR/$MAIN_SCRIPT"
echo "  $SCRIPT_BASE/Modules/$MAIN_SCRIPT"
echo "  $MODULE_DIR"
echo ""
...
rm -f "$COMP_DIR/$MAIN_SCRIPT" 2>/dev/null
rm -f "$SCRIPT_BASE/Modules/$MAIN_SCRIPT" 2>/dev/null
