...
function Bridge.load_pending_params(timeline_list)
    ...
    return {
        ...
        basic_black_border_enabled = raw.basic_black_border_enabled ~= false,
        ...
        complex_mode = raw.complex_mode == true or (type(raw.imported_complex_render_path) == "string" and raw.imported_complex_render_path ~= ""),
        merge_mode = raw.merge_mode ~= false,
        render_nested_segments = raw.render_nested_segments == true,
        keep_complex_cache = raw.keep_complex_cache == true,
        imported_complex_render_path = raw.imported_complex_render_path or "",
        complex_mode_from_import = raw.complex_mode_from_import == true,
        ...
        content_sample_interval = tonumber(raw.content_sample_interval or 5) or 5,
        repeat_fingerprint_samples = tonumber(raw.repeat_fingerprint_samples or 5) or 5,
        mixed_cut_implicit_min_clip_sec = tonumber(raw.mixed_cut_implicit_min_clip_sec or 1) or 1,
