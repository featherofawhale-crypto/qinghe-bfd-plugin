    ...
    local win = disp:AddWindow({
        ...
        ui:VGroup{
            ...
            ui:HGroup{ Spacing = 4,
                ...
                ui:SpinBox{ ID = "StuckFrames", Value = config.CLASSIFICATION.STUCK_FRAMES, Minimum = 1, Maximum = 10, MinimumSize = { 45, 0 } },
                ui:Label{ ID = "ValStuck", Text = "→ 红色标记（需修复）" },
            },
            ui:HGroup{ Spacing = 4,
                ui:Label{ ID = "LblSus", Text = "可疑 ≤", MinimumSize = { 48, 0 } },
                ui:SpinBox{ ID = "SuspectFrames", Value = config.CLASSIFICATION.SUSPECT_FRAMES, Minimum = 3, Maximum = 30, MinimumSize = { 45, 0 } },
            ...
            ui:HGroup{ Spacing = 4,
                ...
                ui:SpinBox{ ID = "PixThreshold", Value = 10, Minimum = 1, Maximum = 50, MinimumSize = { 45, 0 } },
                ui:Label{ ID = "LblPixThUnit", Text = "x0.001（10=标准，越低越严）" },
            },
            ui:HGroup{ Spacing = 4,
                ui:Label{ ID = "LblMinDr", Text = "最短持续", MinimumSize = { 55, 0 } },
                ui:SpinBox{ ID = "MinFrames", Value = 1, Minimum = 1, Maximum = 10, MinimumSize = { 45, 0 } },
            ...
            ui:HGroup{ Spacing = 4,
                ...
                ui:SpinBox{ ID = "ContentSampleInterval", Value = config.DUPLICATE.CONTENT_SAMPLE_INTERVAL, Minimum = 1, Maximum = 30, MinimumSize = { 40, 0 } },
